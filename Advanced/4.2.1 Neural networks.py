...
x = np.array([[111, 13, 12, 1, 161], [125, 13, 66, 1,
                                      468], [46, 6, 127, 2, 961],
              [80, 9, 80, 2, 816], [33, 10, 18, 2, 297], [85, 9, 111, 3, 601],
              [24, 10, 105, 2, 1072], [31, 4, 66, 1, 417], [56, 3, 60, 1, 36],
              [49, 3, 147, 2, 179]])
y = np.array([
    335800., 379100., 118950., 247200., 107950., 266550., 75850., 93300.,
    170650., 149000.
])
...
for item in x_test:
    ...
    h2_out = hidden_activation(np.dot(h1_out, w1) + b1)
    h3_out = output_activation(np.dot(h2_out, w2) + b2)
    print(h3_out)